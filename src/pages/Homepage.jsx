...
function HomePage() {
    ...
    return (
        <>
            <div>
                <AmenitiesDisplay />
                <div className="p-5 d-flex flex-column align-items-center shadow" style={{color: "#293D76"}}>
                    <h4 className="mb-3"> Welcome to Luxuria - Where Dreams Find Luxury.</h4>
                ...
                <h5 className="p-5 text-center" style={{color: "#293D76"}}>Luxuria's exquisite range of accommodations</h5>
                <RoomDisplay />
                <h5 className="mt-5 text-center" style={{color: "#293D76"}}>Luxuria: Where Every Amenity is an Experience</h5>
                <div className="mt-5 p-5 d-flex justify-content-between" style={{color: "#293D76"}}>
                    <div>
                        <img src="/amenities1.jpg" className="shadow" alt="bar" style={{ width: "40vw", height: "50vh", borderRadius: "5px" }} />
                    </div>
                    <div className=" w-50">
                ...
                <div className="p-5 d-flex justify-content-between" style={{color: "#293D76"}}>
                    <div className=" w-50">
                    ...
                    <div>
                        <img src="/amenities2.jpg" className="shadow" alt="bar" style={{ width: "40vw", height: "50vh", borderRadius: "5px" }} />
                    </div>
                </div>
                <div className="p-5 d-flex justify-content-between" style={{color: "#293D76"}}>
                    <div>
                        <img src="/amenities3.jpg" className="shadow" alt="bar" style={{ width: "40vw", height: "50vh", borderRadius: "5px" }} />
                    </div>
                    <div className=" w-50">
                ...
                <div className="p-5 d-flex justify-content-between" style={{color: "#293D76"}}>
                    ...
                    <div>
                        <img src="/amenities4.jpg" className="shadow" alt="bar" style={{ width: "40vw", height: "50vh", borderRadius: "5px" }} />
                    </div>
                </div>
                <div className="mt-5 p-5 d-flex justify-content-between" style={{color: "#293D76"}}>
                    <div>
                        <img src="/amenities5.jpeg" className="shadow" alt="bar" style={{ width: "40vw", height: "50vh", borderRadius: "5px" }} />
                    </div>
                    <div className=" w-50">
